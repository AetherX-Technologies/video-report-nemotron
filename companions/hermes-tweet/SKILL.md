...
## Pair With Video Report Nemotron

Use this companion when a video report needs X/Twitter context around the source,
speaker, launch, audience reaction, or related public claims. Keep the report
pipeline subtitle-first, then use Hermes Tweet only for catalog-listed social
signals and approved follow-up actions.
